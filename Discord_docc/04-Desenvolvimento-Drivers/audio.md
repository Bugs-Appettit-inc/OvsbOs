...
- Decisão em aberto (`ovsbos-dev-stack.md`): portar um subset do **PulseAudio** ou escrever um **servidor simples** do zero. ALSA foi descartado por ser "muito acoplado ao Linux".
