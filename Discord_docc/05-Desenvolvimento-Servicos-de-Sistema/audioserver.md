...
**Decisão em aberto (`ovsbos-dev-stack.md`):** portar um subset do **PulseAudio** ou escrever um servidor simples do zero. Ainda não decidido — depende de quanto esforço o time quer investir vs. quão cedo precisamos de áudio funcionando.
